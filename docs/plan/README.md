...
| [10](实施-10-AI产物展示与GPT-Image.md) | AI 文件产物展示与 GPT Image | 本轮用户目标：生图结果直接展示、受控文件产物、OpenAI-compatible 请求确认 | S1–S2 | 01-S2、默认 pi 能力 CLI | **S1–S2 已完成：4158/4158 单测、真实 Codex 生图、真实窗口 artifact 视觉、应用与目录包验收均通过；兼容 API 拒绝后不触网** |
