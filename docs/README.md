...
| 决定「接下来做什么」 | [实施计划](plan/README.md) | **只列未完成项**：9 份主题实施文档，每份切成「一次会话一片」 |
...
- 功能完成后统一进入发布门槛（见[实施-09](plan/实施-09-交付与验收收尾.md)），不能用历史包结果替代最终源码验收。
...
- 上下文管理有**两份**设计文档：[方案-上下文工具内的自动压缩](design/方案-上下文工具内的自动压缩-2026-09-15.md)（砚自己的设计 + 阶段落地记录 + §12 阶段 4 契约 + §13 对外部参考方案的对齐结论）与
  ...
  两者关系与取舍只看前者的 §13；剩余任务见[实施-06 上下文管理收尾](plan/实施-06-上下文管理收尾.md)。
