...
> 2026-09-18 建立。本文**取代** [未完成工程排期](../2026-09-15-未完成排期.md)（已归档）的「活入口」地位。
...
5. **判断「某项是否真的未完成」**：以 [HANDOFF](../../dev/HANDOFF.md) 的「当前未完成」与
   [已完成归档](../2026-09-17-已完成归档.md) 的「尚未完成」表为准。
...
所以另立一份 [并行代理编排](../../plan/active/编排-并行代理分工-2026-09-19.md)：它只回答**哪些片能同时开工、
...
[01 §1](../../plan/active/实施-01-默认pi架构迁移.md)；逐项判定集中在 01-S1 与 [06](../../plan/active/实施-06-上下文管理收尾.md)-S1。
...
4. 归档不放流水账：`docs/archive/` 只收「已结束或已被取代」的整份文档，
   文件名带日期前缀，索引见 [archive/README](../README.md)。
